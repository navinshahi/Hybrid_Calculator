...
<html lang="en">
<head>
    <title>Calculate Angle B/w Hour & Minute Hands</title>
    ...
    <meta name="description" content="Find Angle Between Hour hand and Minute hand. Enter value of Hour hand and Minute hand & then calculate angle between them.">
    <meta name="keywords" content="angle bw hour and minute,clock angle,clock angle hybrid calculator,hour and minute, angle bw h and m,find clock angle online.">
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <div class="main_frame">
        ...
        <div class="frame_2">
            <div class="subframe_1"><div class="text_1">Angle B/w Hour & Minute</div></div>
            <div class="subframe_2">
                <div class="subsub1">
                <div class="subcont1">  
                <input type="number" id="select1" class="form-control"  onkeydown="if(event.key==='.'){event.preventDefault();}" min="00" max="11" placeholder="Enter Hour (HH)" style="margin-top:2%;" oninput="calculate()">
                <input type="number" id="select2" class="form-control"  onkeydown="if(event.key==='.'){event.preventDefault();}" min="00" max="59" placeholder="Enter Minute (MM)" style="margin-top:2%;" oninput="calculate()">
                </div>  
                </div>
                <div class="subsub2">
                <div class="subcont1">
...
<script>
    ...
    if(select1!=0){
    if(select1<0 || select1>11){
        alert("Please Input Hour Between 0 - 11 !!!");
        document.getElementById("select1").value=NaN;
        document.getElementById("select2").value=NaN;
    }}
    if(select2<0 || select2>59){
        alert("Please Input Minute Between 0 - 59 !!!");
        document.getElementById("select1").value=NaN;
        document.getElementById("select2").value=NaN;
    }
    if((select1>=0 && select1<=11) && (select2>=0 && select2<=59)){
    var result=document.getElementById("input2");
    var val=(30*select1)-((11/2)*select2);
    result.value="Angle from Hour to Minute hand : "+String(Math.abs(val));}
}
    </script>
    <script type="text/javascript">
